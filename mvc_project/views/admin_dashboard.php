...
<div class="sidebar">
    ...
    <a href="../controllers/logout.php" class="logout"><span class="icon"><i class='bx  bx-arrow-out-left-square-half'></i> </span>Logout</a>
</div>
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><img src="<?= htmlspecialchars('../' . ltrim($row['ground_picture'], '/')); ?>" alt="Ground Image"></td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
