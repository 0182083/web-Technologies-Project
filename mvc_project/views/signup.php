...
<body>
    <div class="main">
        <div class="box1">
            ...
            <form id="signupForm" action="../controllers/process.php" method="post" >
    ...
    <script>
        ...
        form.addEventListener("submit", async function (e) {
            ...
            const response = await fetch("../controllers/process.php", {
                method: "POST",
                body: formData
            });
        ...
        function availabilityCheck(field, validator) {
            ...
            const runCheck = () => {
                ...
                xhr.open("POST", "../controllers/process.php", true);
