...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/book_facility.css">
    <script>
    function loadSlots() {
    ...
    <div class="container">
        ...
        <form method="POST" class="form-card">
            <div class="form-group">
                ...
                <select name="facility_id" id="facility" onchange="loadSlots()" required>
            ...
            <button type="submit" name="book" class="btn-success">Confirm & Book</button>
        </form>
    </div>
